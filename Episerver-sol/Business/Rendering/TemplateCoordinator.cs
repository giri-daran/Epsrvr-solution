...
namespace EpiserverBH.Business.Rendering
{
    ...
    public class TemplateCoordinator : IViewTemplateModelRegistrator
    {
        ...
        public const string BauschBlockPageFolder = "/Views/Bausch/{1}/{0}";
        ...
        public void Register(TemplateModelCollection viewTemplateModelRegistrator)
        {
            ...
            viewTemplateModelRegistrator.Add(typeof(RawHTML), new TemplateModel
            {
                Name = "RawHTMLRenderer",
                Inherit = true,
                AvailableWithoutTag = true,
                Path = "/Views/Shared/DisplayTemplates/XhtmlFriendlyURL.cshtml" //DisplayTemplatePath("_TokenXhtmlString.cshtml")
            });
        }
