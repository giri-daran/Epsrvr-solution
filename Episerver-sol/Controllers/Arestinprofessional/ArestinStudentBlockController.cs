...
{
    public class ArestinStudentBlockController : BlockComponent<ArestinStudentBlock>                           //BaseLoginBlockController<ArestinStudentBlock>
    {
        ...
        public ArestinStudentBlockController(LocalizationService localizationService, IHttpContextAccessor _iHttpContextAccessor, ApplicationSignInManager<SiteUser> signInManager, ApplicationUserManager<SiteUser> userManager, IProfileRepository profileRepo, IConfiguration _configuration)
        {
        ...
        protected override IViewComponentResult InvokeComponent(ArestinStudentBlock currentBlock)
        {
            var model = new ArestinStudentViewModel
            {
        ...
        [HttpPost]
        public virtual ActionResult Submit(ArestinStudentViewModel loginmodel, ArestinStudentBlock loginBlock, PageData pageData)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> InternalLogin(ArestinStudentViewModel viewModel)
        {
            //var returnUrl = GetSafeReturnUrl(Request.UrlReferrer);
            var returnUrl = "/program-for-students";
        ...
        /// <summary>
        /// Getting Student Profile Details for Existing Users from EPiServerDB
        /// </summary>
