...
namespace EpiserverBH.Helpers
{
    public static class HtmlHelpers
    {
        ...
        public static void UploadPdfinCms(string filepath, string folderName)
        {
            try
            {
        ...
        public static string ReturnString(this SitePageData PRCString, string Property)
        {

            return PRCString.Property[Property].Value.ToString();
        }
        public static string ToExternalImage(this String xhtmlString)
        {
            var result = new StringBuilder();

            result.Append(xhtmlString != null ? UrlResolver.Current.GetUrl(new UrlBuilder(xhtmlString), ContextMode.Default) : xhtmlString);
